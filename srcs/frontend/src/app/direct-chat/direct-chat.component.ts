...
export class DirectChatComponent implements OnInit {
	...
	invite_game() {
		var gameConfig = new DefaultGame();
		this.global = { player1: this.Me, player2: this.Dest, gameConfig: gameConfig };
		this.global2Event.emit(this.global);
		this.socketService.displayInvitation(this.Dest, this.Me, gameConfig);
	}
